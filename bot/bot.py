...
from handlers import help_handler, dice_handler, start_handler
...
async def main() -> None:
    ...
    # Здесь мы присеваем переменной TELEGRAM_BOT_TOKEN значение, котрое он вытащил по ключу из “.env”.
