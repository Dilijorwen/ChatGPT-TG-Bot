...
def gpt(text):
    ...
    completion = client.chat.completions.create(
        ...
        messages=[
            ...
            {"role": "system", "content": "You are a real person who works as a programmer in a high position"},
...
async def gpt_handler(message: Message):
    ...
    try:
        ...
        await message.reply(response)  # Тут запрос принимается, отдаётся на обработку и выводитс
        print(response)
        ...
        print(f"это e {e}")  # Если что-то пошло не так, то мы ловим ошибку и выводим в консоль
